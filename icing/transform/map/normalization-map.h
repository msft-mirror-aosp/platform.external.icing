...
#ifndef THIRD_PARTY_ICING_TRANSFORM_MAP_NORMALIZATION_MAP_H_
#define THIRD_PARTY_ICING_TRANSFORM_MAP_NORMALIZATION_MAP_H_
...
#endif  // THIRD_PARTY_ICING_TRANSFORM_MAP_NORMALIZATION_MAP_H_
