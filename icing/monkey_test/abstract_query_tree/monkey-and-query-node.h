...
#ifndef ICING_MONKEY_TEST_ABSTRACT_QUERY_TREE_MONKEY_AND_QUERY_NODE_H_
#define ICING_MONKEY_TEST_ABSTRACT_QUERY_TREE_MONKEY_AND_QUERY_NODE_H_
...
// MonkeyNode that represents logical AND over subqueries. This node is
// equivalent to androidx.appsearch.ast.AndNode in the AppSearch AST library.
class MonkeyAndQueryNode : public MonkeyAbstractNaryQueryNode {
 public:
  explicit MonkeyAndQueryNode(
...
#endif  // ICING_MONKEY_TEST_ABSTRACT_QUERY_TREE_MONKEY_AND_QUERY_NODE_H_
