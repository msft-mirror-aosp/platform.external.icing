...
#ifndef THIRD_PARTY_ICING_RESULT_RESULT_STATE_MANAGER_H_
#define THIRD_PARTY_ICING_RESULT_RESULT_STATE_MANAGER_H_
...
#endif  // THIRD_PARTY_ICING_RESULT_RESULT_STATE_MANAGER_H_
