...
#ifndef THIRD_PARTY_ICING_UTIL_DOCUMENT_VALIDATOR_H_
#define THIRD_PARTY_ICING_UTIL_DOCUMENT_VALIDATOR_H_
...
#endif  // THIRD_PARTY_ICING_UTIL_DOCUMENT_VALIDATOR_H_
