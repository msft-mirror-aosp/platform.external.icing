...
//    //third_party/icing:icing-search-engine_benchmark
//
//    $ blaze-bin/third_party/icing/icing-search-engine_benchmark
...
//    //third_party/icing:icing-search-engine_benchmark
//
//    $ adb push blaze-bin/third_party/icing/icing-search-engine_benchmark
//    /data/local/tmp/
//
